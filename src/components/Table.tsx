              ...
              <table className="min-w-full divide-y divide-gray-300">
                <thead className="bg-gray-200">
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="w-1/2 border border-green-500 px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
                    >
                      Description
                    </th>
                    ...
                    <th
                      scope="col"
                      className="relative w-1/4 border border-blue-400 py-3.5 pl-3 pr-4 sm:pr-6"
                    >
